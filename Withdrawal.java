...
public class Withdrawal extends Transaction
{
   ...
   public void execute()
   {
      ...
      do
      {
         ...
         if ( amount != CANCELED && amount != WrongValue)
         {
      ...
      while ( userChoice == 0 )
      {
         ...
         switch ( input )
         {
            ...
            case CustomAmount: // the user enter custom amount
                screen.displayMessageLine( "Only the muliples of HKD100 is allowed" );
                screen.displayMessageLine( "Enter withdrawal amount: " );
                double temp = keypad.getDoubleInput();                
                if(temp - (int)temp != 0){
                    userChoice = WrongValue;
                }else if (temp % 100 == 0){
                    userChoice = (int)temp;
                }else{
                    userChoice = WrongValue;
